...
demo = {
    ...
    // Assuming this function is part of your notification.js file
    showNotifications: function(from, align, message) {
        $.notify({
            icon: "nc-icon nc-app",
            message: message
        }, {
            type: 'info', // You can change this to any type you want, e.g., 'success', 'warning', 'danger'
            timer: 8000,
            placement: {
                from: from,
                align: align
